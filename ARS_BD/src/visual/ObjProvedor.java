...
public class ObjProvedor extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ObjProvedor dialog = new ObjProvedor();
	...
	public ObjProvedor() {
		...
		contentPanel.setLayout(null);
		{
			...
			label.setIcon(new ImageIcon(ObjProvedor.class.getResource("/imagenes/icoPaciente.jpg")));
